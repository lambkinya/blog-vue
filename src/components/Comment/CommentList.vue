      ...
      <div class="reply-item" v-for="(comment, index) of commentList" :key="comment.no">
        ...
        <div class="content-warp">
          <div class="user-info">
            ...
            <svg-icon v-if="comment.coderNo == 'YA251651564'" icon-class="badge"></svg-icon>
          </div>
          ...
          <div class="reply-info">
            ...
            <span class="reply-like" @click="like(comment)">
              <svg-icon class="like" icon-class="like" size="0.8rem" :class="isLike(comment.no)"
          ...
          <div class="sub-reply-item" v-for="reply of comment.childrenCommentList" :key="reply.no">
            ...
            <div class="reply-info">
              ...
              <span class="reply-like" @click="like(reply)">
                <svg-icon class="like" icon-class="like" size="0.8rem" :class="isLike(reply.no)"
                  style="margin-right: 5px"></svg-icon>
  ...
  const getList = () => {
    ...
    getCommentList(queryParams.value).then(({ data }) => {
      if (queryParams.value.pageNo == 1) {
        ...
        console.log("data", commentList.value);
      } else {
