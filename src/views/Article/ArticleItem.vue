<template>
  <div class="article-item" v-animate="['slideUpBigIn']" v-for="article of articleList" :key="article.no">
    <!-- 文章缩略图 -->
    <div class="article-cover">
      <router-link :to="`/article/${article.no}`" href="">
    ...
    <div class="article-info">
      ...
      <h3 class="article-title">
        <router-link :to="`/article/${article.no}`">
          {{ article.title }}
        </router-link>
      </h3>
      <!-- 文章内容 -->
      ...
      <!-- 阅读按钮 -->
      <router-link class="article-btn" :to="`/article/${article.no}`">more...</router-link>
    </div>
  </div>
